...
$bg_video_wrapper_classes = implode( ' ', apply_filters( 'ba_cheetah_row_bg_video_wrapper_class', array( 'ba-cheetah-bg-video' ), $row ) );
...
<?php endif; ?>
<?php endif; ?>>
<div class="ba-cheetah-bg-video-player"></div>
<?php if ( $row->settings->bg_video_audio ) : ?>
<div class="ba-cheetah-bg-video-audio"><span>
	<i class="fas ba-cheetah-audio-control fa-volume-off"></i>
