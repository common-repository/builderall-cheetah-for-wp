<input
type="text"
class="text text-full ba-cheetah-suggest-field<# if ( data.field.className ) { #> {{data.field.className}}<# } #>"
name="{{data.name}}"
...
placeholder="<# if ( data.field.placeholder ) { #>{{data.field.placeholder}}<# } else { #><?php esc_attr__( 'Start typing...', 'ba-cheetah' ); ?><# } #>"
/>
