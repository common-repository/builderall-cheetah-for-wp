(function($, BACheetah) {
    ...
    */
    var SaveManager = {
         ...
         */
        init: function() {
	        this.messages = BACheetahStrings.savedStatus;
            this.$savingIndicator = $('.ba-cheetah--saving-indicator');

            BACheetah.addHook('didBeginAJAX', this.onLayoutSaving.bind(this));
            BACheetah.addHook('didCompleteAJAX', this.onLayoutSaved.bind(this));
            BACheetah.addHook('didPublishLayout', this.onLayoutPublished.bind(this));
            BACheetah.addHook('publishAndRemain', this.onPublishAndRemain.bind(this));
            ...
            BACheetah.addHook('didShowLightbox', this.setLayoutNeedsPublish.bind(this));

            if ( BACheetahConfig.layoutHasDraftedChanges || ! BACheetahConfig.builderEnabled ) {    
        ...
        setLayoutNeedsPublish: function() {
            if ( !this.layoutNeedsPublish ) {
                ...
                $('body').addClass('ba-cheetah--layout-has-drafted-changes');
            }
        },
        ...
        isUpdatingLayout: function( action ) {
            ...
            if ( 'ba_cheetah_notifications' == action ) return false;
        ...
        onLayoutSaved: function( e, data ) {
	        if ( this.isUpdatingLayout( data.ba_cheetah_data.action ) ) {
        ...
        onLayoutPublished: function() {
            ...
            $('body').removeClass('ba-cheetah--layout-has-drafted-changes');
            this.resetStatusMessage();
        },
        ...
        showStatusMessage: function(message, toolTip) {
            ...
            if (! BACheetah.isUndefined(toolTip)) {
        ...
        onPublishAndRemain: function() {
            ...
            //if (this.layoutNeedsPublish) {
            BACheetah._publishLayout(false, true);
			/*
            } else {
