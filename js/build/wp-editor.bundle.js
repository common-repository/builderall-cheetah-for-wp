...
var _BACheetahConfig = BACheetahConfig,
    builder = _BACheetahConfig.builder,
    strings = _BACheetahConfig.strings,
    urls = _BACheetahConfig.urls;
  ...
  _createClass(LayoutBlockEditPre_5_3, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Placeholder, {
        ...
        label: strings.title,
        className: "ba-cheetah-layout-launch-view"
    ...
    value: function toggleEditor() {
      ...
      var enabledClass = 'ba-cheetah-layout-enabled';
...
var LayoutBlockEditConnectedPre_5_3 = compose(withDispatch(function (dispatch, ownProps) {
  ...
  var builder = dispatch('ba-cheetah');
  return {
...
var _BACheetahConfig = BACheetahConfig,
    builder = _BACheetahConfig.builder,
    strings = _BACheetahConfig.strings;
var version = BACheetahConfig.wp.version;
...
if (builder.access && builder.unrestricted || builder.enabled) {
  registerBlockType('ba-cheetah/layout', {
    title: strings.title,
    description: strings.description,
    icon: 'welcome-widgets-menus',
    category: 'layout',
...
registerPlugin('ba-cheetah-plugin-sidebar', {
  icon: 'welcome-widgets-menus',
  ...
  _createClass(BuilderMoreMenuItemPre_5_3, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(PluginSidebarMoreMenuItem, null, /*#__PURE__*/React.createElement("div", {
        className: "ba-cheetah-plugin-sidebar-button",
    ...
    value: function hasBuilderBlock() {
      ...
      var builder = blocks.filter(function (block) {
        return 'ba-cheetah/layout' === block.name;
      });
    ...
    value: function convertToBuilder() {
      ...
      var block = createBlock('ba-cheetah/layout', {
        content: content
      });
      insertBlock(block, 0);
      removeBlocks(clientIds);
...
var BuilderMoreMenuItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(BuilderMoreMenuItem, [{
    ...
    value: function render() {
      if (this.hasBuilderBlock()) {
        jQuery('body').addClass('ba-cheetah-blocks');
        jQuery(document).trigger('ba-cheetah-fix-blocks');
      }
...
jQuery(document).on('ba-cheetah-fix-blocks', function () {
  // DEFINE: Validation variables
  var hasGutenbergClasses = jQuery('body').hasClass('post-php') === true && jQuery('.block-editor').length >= 1 && jQuery('body').hasClass('ba-cheetah-blocks');
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/wp-editor/index.js");
