...
var after = {
  TOGGLE_PANEL: function TOGGLE_PANEL(action, store) {
    ...
    if ('assistant' === currentPanel) {
      html.classList.add('ba-cheetah-assistant-visible');
    } else {
      html.classList.remove('ba-cheetah-assistant-visible');
    }
  },
...
(0,_registry__WEBPACK_IMPORTED_MODULE_0__.registerStore)(key, {
  ...
  state: {
    ...
    colorScheme: BACheetahConfig.userSettings.skin,
    panels: {}
  }
});
...
var _data$getSystemAction = _data__WEBPACK_IMPORTED_MODULE_3__.getSystemActions(),
    ...
    togglePanel = _data$getSystemAction.togglePanel; // Setup public API - window.BA.Builder
...
window.BA = _objectSpread(_objectSpread({}, api), {}, {
  Builder: Builder
}); // Render UI

var root = document.getElementById('ba-cheetah-ui-root');
...
var BaCheetahBuilderUI = function BaCheetahBuilderUI() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BaCheetahBuilderUI);
...
var InlineEditor = /*#__PURE__*/function (_Component) {
  ...
  function InlineEditor(props) {
    ...
    _this.layoutClass = ".ba-cheetah-content-".concat(postId ? postId : BACheetahConfig.postId);
    return _this;
  }
  ...
  _createClass(InlineEditor, [{
    ...
    value: function setupHooks() {
      ...
      if (!window.tinymce || this.hooked || !BACheetahConfig.inlineEnabled) {
        return;
      }
      ...
      if (BACheetah) {
        // Init actions
        BACheetah.addHook('settingsConfigLoaded', initEditables);
        BACheetah.addHook('restartEditingSession', initEditables); // Destroy actions

        BACheetah.addHook('endEditingSession', destroyAllEditables);
        BACheetah.addHook('didStartNodeLoading', destroyLoadingEditables); // Refresh actions

        BACheetah.addHook('didRenderLayoutComplete', refreshEditables);
        BACheetah.addHook('didDeleteRow', refreshEditables);
        BACheetah.addHook('didDeleteColumn', refreshEditables);
        BACheetah.addHook('didDeleteModule', refreshEditables);
      }
    ...
    value: function initEditables() {
      ...
      var _BACheetahSettingsCon = BACheetahSettingsConfig,
          editables = _BACheetahSettingsCon.editables;
      var content = jQuery(this.layoutClass);

      if (content.length) {
        for (var key in editables) {
          var selector = ".ba-cheetah-module[data-type=\"".concat(key, "\"]:not(.ba-cheetah-editable):not(.ba-cheetah-node-global)");
          content.find(selector).each(function (index, module) {
            module = jQuery(module);
            module.addClass('ba-cheetah-editable');
            module.delegate('.ba-cheetah-block-overlay', 'dblclick.ba-cheetah-inline-editing-init', function (e) {
    ...
    value: function initEditable(e, module) {
      ...
      var _BACheetah = BACheetah,
          preview = _BACheetah.preview; // Don't setup if we have a parent that needs to save.

      if (preview) {
        var isParent = module.parents(".ba-cheetah-node-".concat(preview.nodeId)).length;
      ...
      module.undelegate('.ba-cheetah-block-overlay', 'dblclick.ba-cheetah-inline-editing-init');
    }
  }, {
    key: "setupEditable",
    value: function setupEditable(module) {
      ...
      var settings = BACheetahSettingsConfig.nodes[nodeId];
      ...
      var nodeClass = ".ba-cheetah-node-".concat(nodeId, " ");
      var editorId = "ba-cheetah-inline-editor-".concat(nodeId);
      var overlay = jQuery("<div id=\"".concat(editorId, "\" class=\"ba-cheetah-inline-editor\"></div>"));
      var form = jQuery(".ba-cheetah-settings[data-node=".concat(nodeId, "]"));
      var connections = settings.connections;
      module.append(overlay);
      module.delegate('.ba-cheetah-block-overlay', 'dblclick', this.onModuleOverlayClick.bind(this));
      module.on('mouseleave', this.onModuleMouseleave.bind(this));

      var _loop = function _loop(key) {
        var data = config[key];
        var selector = BACheetahPreview.getFormattedSelector(nodeClass, data.selector);
        var editable = jQuery(selector);
        var editableHTML = editable.html();
        var connection = form.find("#ba-cheetah-field-".concat(key, " .ba-cheetah-field-connection-value"));
        ...
        tinymce.init({
          ...
          //relative_urls: false,
          //convert_urls: false,
          // skin: BACheetah ? false : 'lightgray',
          // skin_url: BACheetah ? false : "".concat(tinyMCEPreInit.baseURL, "/skins/lightgray/"),
          //theme: 'modern',
    ...
    value: function destroyEditables(modules) {
      ...
      var overlays = modules.find('.ba-cheetah-inline-editor');
      var extras = jQuery('.wplink-autocomplete, .ui-helper-hidden-accessible');
      editables.removeAttr('contenteditable');
      modules.undelegate('.ba-cheetah-block-overlay', 'dblclick');
      modules.off('mouseleave');
      modules.removeClass('ba-cheetah-editable');
      overlays.remove();
      extras.remove();
    }
  }, {
    ...
    value: function destroyAllEditables() {
      var content = jQuery(this.layoutClass);
      var modules = content.find('.ba-cheetah-editable');
    ...
    value: function destroyLoadingEditables(e, node) {
      ...
      if (!modules.hasClass('ba-cheetah-module')) {
        modules = modules.find('.ba-cheetah-module');
      }
    ...
    value: function getEditorEventVars(target) {
      ...
      var module = editable.closest('.ba-cheetah-module');
      var nodeId = module.data('node');
      return {
        editable: editable,
        module: module,
    ...
    value: function onEditorChange(e) {
      ...
      var settings = jQuery(".ba-cheetah-settings[data-node=\"".concat(nodeId, "\"]"));
      var content = editor.getContent();

      if (!settings.length) {
        return;
      } else if ('editor' === field.type) {
        var textarea = settings.find("#ba-cheetah-field-".concat(field.name, " textarea.wp-editor-area"));
    ...
    value: function onEditorFocus(e) {
      ...
      var overlay = module.find('.ba-cheetah-inline-editor');
      ...
      if (editor.settings.toolbar) {
        overlay.removeClass('ba-cheetah-inline-editor-no-toolbar');
      } else {
        overlay.addClass('ba-cheetah-inline-editor-no-toolbar');
      }

      module.addClass('ba-cheetah-editable-focused');
    ...
    value: function onEditorBlur(e) {
      ...
      overlay.removeClass('ba-cheetah-inline-editor-no-toolbar');
      module.removeClass('ba-cheetah-editable-focused');
    ...
    value: function onModuleOverlayClick(e) {
      var actions = jQuery(e.target).closest('.ba-cheetah-block-overlay-actions');
      var module = jQuery(e.currentTarget).closest('.ba-cheetah-module');
      var editorId = module.find('.mce-content-body').first().attr('id');

      if (actions.length || BACheetah._colResizing) {
        return;
      }
    ...
    value: function showEditorOverlay(module) {
      ...
      this.hideEditorOverlays();
      overlay.show();
      var active = jQuery('.ba-cheetah-inline-editor-active-toolbar');
      active.removeClass('ba-cheetah-inline-editor-active-toolbar');
      var toolbar = overlay.find('> .mce-panel:visible');
      toolbar.addClass('ba-cheetah-inline-editor-active-toolbar');
    }
  }, {
    key: "hideEditorOverlays",
    value: function hideEditorOverlays() {
      jQuery('.ba-cheetah-inline-editor, .mce-floatpanel').hide();
    }
  }, {
    key: "showNodeOverlays",
    value: function showNodeOverlays() {
      jQuery('.ba-cheetah-block-overlay').show();
    }
  }, {
    key: "hideNodeOverlays",
    value: function hideNodeOverlays() {
      jQuery('.ba-cheetah-block-overlay').hide();
    }
  }, {
    ...
    value: function showModuleSettings(module) {
      var type = module.data('type');
      var nodeId = module.data('node');
      var parentId = module.closest('.ba-cheetah-col').data('node');
      var global = module.hasClass('ba-cheetah-node-global');
      var settings = jQuery(".ba-cheetah-settings[data-node=\"".concat(nodeId, "\"]"));
...
var lite = !BACheetahConfig.isBuilderallUser && !BACheetahConfig.autenticated;
...
var Post = function Post(props) {
  ...
  if ('string' === typeof props.url && '' !== props.url) {
    var url = lite ? props.url + '?utm_medium=ba-cheetah-lite&utm_source=builder-ui&utm_campaign=notification-center' : props.url + '?utm_medium=ba-cheetah-pro&utm_source=builder-ui&utm_campaign=notification-center';
    post = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
      className: "ba-cheetah-ui-post",
      href: url,
      target: "_blank",
      rel: "noopener noreferrer"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "ba-cheetah-ui-post-date"
    }, date), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "ba-cheetah-ui-post-title"
    }, props.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "ba-cheetah-ui-post-content",
...
var NotificationsPanel = /*#__PURE__*/function (_Component) {
  ...
  _createClass(NotificationsPanel, [{
    ...
    value: function getPosts(posts) {
      var view,
          renderedPosts,
          strings = BACheetahStrings.notifications;
      ...
      if (0 < posts.length) {
        renderedPosts = posts.map(function (item) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Post, {
            ...
            date: item.date,
            url: item.meta._ba_cheetah_notification[0]
        ...
        view = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
          className: "ba-cheetah-panel-no-message"
        }, strings.none);
      }
    ...
    value: function render() {
      var content = this.getPosts(this.props.posts),
          strings = BACheetahStrings.notifications;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "ba-cheetah-notifications-panel"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "ba-cheetah-panel-title"
      }, strings.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "ba-cheetah-nanoscroller",
        ref: this.setupScroller
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "ba-cheetah-nanoscroller-content"
      }, content)));
    }
  }]);
...
var NotificationsManager = /*#__PURE__*/function (_Component2) {
  ...
  function NotificationsManager(props) {
    ...
    var out = {};
    var data = BACheetahConfig.notifications.data; // make sure we have valid json.
    ...
    BACheetah.addHook('toggleNotifications', _this.onToggleNotifications.bind(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(NotificationsManager, [{
    ...
    value: function render() {
      ...
      BACheetah.triggerHook('notificationsLoaded');
...
var Frame = function Frame(_ref) {
  ...
  var classes = classnames__WEBPACK_IMPORTED_MODULE_1___default()('ba-cheetah-workspace-panel', className);
...
var ShortcutsList = function ShortcutsList(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "ba-cheetah-ui-shortcut-list"
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      ...
      className: "ba-cheetah-ui-shortcut-item-keycode",
...
var Panel = function Panel(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "ba-cheetah-ui-panel"
  }, rest, {
    onClick: stopProp
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "ba-cheetah-ui-panel-topbar"
  }, title && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "ba-cheetah-ui-panel-title"
    ...
    className: "ba-cheetah-ui-panel-content"
  }, children)));
};
...
/*!***************************************!*\
  !*** external "BA.vendors.BBAppCore" ***!
  \***************************************/
/***/ ((module) => {

"use strict";
module.exports = BA.vendors.BBAppCore;
