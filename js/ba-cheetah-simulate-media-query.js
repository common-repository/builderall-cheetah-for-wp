( function( $ ) {
	...
	var SimulateMediaQuery = {
		...
		applyStyles: function()
		{
			...
			if ( '' !== styles.all ) {
				style = $( '<style class="ba-cheetah-media-query" data-query="all"></style>' );
			...
			for ( i = 0; i < styles.queries.length; i++ ) {
				...
				style = $( '<style class="ba-cheetah-media-query" data-query="' + query.media + '" data-value="' + query.width + '"></style>' );
				this.styles.push( style );
				head.append( style );
