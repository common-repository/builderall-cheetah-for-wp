 ...
 *
 * @class   BACheetahTimezones

 */
final class BACheetahTimezones {
	...
	static public function build_timezones( $selected_zone ) {
		...
		if ( empty( $selected_zone ) ) {
			$structure[] = '<option selected="selected" value="">' . __( 'Select a city', 'ba-cheetah' ) . '</option>';
		}
		...
		// Do UTC
		$structure[] = '<optgroup label="' . esc_attr__( 'UTC', 'ba-cheetah' ) . '">';
		$selected    = '';
		if ( 'UTC' === $selected_zone ) {
			$selected = 'selected="selected" ';
		}
		$structure[] = '<option ' . $selected . 'value="' . esc_attr__( 'UTC', 'ba-cheetah' ) . '">' . __( 'UTC', 'ba-cheetah' ) . '</option>';
		$structure[] = '</optgroup>';
